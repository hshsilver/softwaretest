...
public class TestStudentList {
  ...
  public void setUp() throws Exception {
	  ...
	  driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);//可以设置大一点。
  }
...
//    	System.out.println(spassword_now);
...
//        System.out.println(driver.findElement(By.id("student-id")));
//        Thread.sleep(5000);
...
////    driver.findElement(By.id("kw")).click();
//    driver.findElement(By.name("id")).clear();
//    driver.findElement(By.name("id")).sendKeys("3016204310");
//    
//    WebElement we2 = driver.findElement(By.name("password"));
//    we2.click();
////    driver.findElement(By.id("kw")).click();
//    driver.findElement(By.name("password")).clear();
//    driver.findElement(By.name("password")).sendKeys("204310");
//    
//    driver.findElement(By.id("btn_login")).click();
//    System.out.println(driver.findElement(By.id("student-id")));
//    Thread.sleep(5000);
//    assertEquals("3016204310", driver.findElement(By.id("student-id")).getText());//.getText()，需要得到文本内容。
//    assertEquals("何书豪", driver.findElement(By.id("student-name")).getText());
//    assertEquals("https://github.com/hshsilver/softwaretest", driver.findElement(By.id("student-git")).getText());
//  }
